...
class GameplayCustomizeState extends MusicBeatState
{
    ...
    var background:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('stagebackC','shared'));
    var curt:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('stagecurtainsC','shared'));
    var front:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('stagefrontC','shared'));
