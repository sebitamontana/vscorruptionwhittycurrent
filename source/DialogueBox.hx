...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		var gaming:Bool = PlayState.SONG.song.toLowerCase() != 'deprave' && PlayState.SONG.song.toLowerCase() != 'b-deprave' && PlayState.SONG.song.toLowerCase() != 'pressure' && PlayState.SONG.song.toLowerCase() != 'b-pressure' && PlayState.SONG.song.toLowerCase() != 'b-infernum' && PlayState.SONG.song.toLowerCase() != 'infernum';
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				add(face);
			case 'deprave' | 'pressure' | 'infernum' | 'lo-fight-b-side' | 'overhead-b-side' | 'ballistic-b-side':
				hasDialog = true;
		...
		if (gaming)
			...
			else
			{
					...
					portraitLeft.frames = Paths.getSparrowAtlas('whittyPortC', 'bonusWeek');
					...
					portraitRight.frames = Paths.getSparrowAtlas('boyfriendPortC', 'bonusWeek');
			...
			if (PlayState.SONG.song.toLowerCase() != 'deprave' && PlayState.SONG.song.toLowerCase() != 'pressure' && PlayState.SONG.song.toLowerCase() != 'infernum')
			{
		...
		if (PlayState.SONG.song.toLowerCase() != 'deprave' && PlayState.SONG.song.toLowerCase() != 'b-lo-fight' && PlayState.SONG.song.toLowerCase() != 'pressure' && PlayState.SONG.song.toLowerCase() != 'b-overhead')
			swagDialogue.sounds = [FlxG.sound.load(Paths.sound('pixelText'), 0.6)];
		else if (PlayState.SONG.song.toLowerCase() == 'infernum' || PlayState.SONG.song.toLowerCase() == 'b-ballistic')
		...
		switch (curCharacter)
		{
			case 'dad':
				...
				if (!portraitLeft.visible)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'infernum')
						swagDialogue.sounds =  [FlxG.sound.load(Paths.sound('ballistic', 'shared'), 0.6)];
					else if (PlayState.SONG.song.toLowerCase() == 'deprave' || PlayState.SONG.song.toLowerCase() == 'pressure')
						swagDialogue.sounds =  [FlxG.sound.load(Paths.sound('whitty', 'shared'), 0.6)];
				}
			case 'bf':
				portraitLeft.visible = false;
