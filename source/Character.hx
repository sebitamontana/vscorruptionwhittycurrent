...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				case 'blank':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('characters/blank');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
				...
				playAnim('danceRight');
				case 'gf-corrupt':
				tex = Paths.getSparrowAtlas('characters/gfCorrupt');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
				...
				playAnim('danceRight');
			case 'gf-whitty':
				tex = Paths.getSparrowAtlas('GF_Standing_SwayC', 'bonusWeek');
				frames = tex;
			...
			case 'whitty': // whitty reg (lofight,overhead)
				...
				case 'whittyCorrupt': 
				tex = Paths.getSparrowAtlas('WhittyCorrupt', 'bonusWeek');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24);
				animation.addByPrefix('singUP', 'Sing Up', 24);
				animation.addByPrefix('singRIGHT', 'Sing Right', 24);
				...
				addOffset("singDOWN", 0, -30);
				case 'whittyCorrupt2': 
				tex = Paths.getSparrowAtlas('WhittyCorrupt2', 'bonusWeek');
				frames = tex;
				animation.addByPrefix('idle', 'Idle', 24);
				animation.addByPrefix('singUP', 'Sing Up', 24);
				animation.addByPrefix('singRIGHT', 'Sing Right', 24);
			...
			case 'whittyBSideCrazy':
				...
				tex = Paths.getSparrowAtlas('WhittyCrazyCorrupt', 'bonusWeek');
				frames = tex;
				animation.addByPrefix('idle', 'Whitty idle dance', 24);
				animation.addByPrefix('singUP', 'Whitty Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'whitty sing note right', 24);
				...
				tex = Paths.getSparrowAtlas('WhittyCrazyCorrupt2', 'bonusWeek');
				frames = tex;
				animation.addByPrefix('idle', 'Whitty idle dance', 24);
				animation.addByPrefix('singUP', 'Whitty Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'whitty sing note right', 24);
				...
				addOffset("singLEFT", 50);
				addOffset("singDOWN", 75, -150);
				case 'whittyCrazyCorrupt3': 
				tex = Paths.getSparrowAtlas('WhittyCrazyCorrupt3', 'bonusWeek');
				frames = tex;
				animation.addByPrefix('idle', 'Whitty idle dance', 24);
				animation.addByPrefix('singUP', 'Whitty Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'whitty sing note right', 24);
			...
			case 'bf':
				...
				flipX = true;
				case 'bf-corrupt':
				var tex = Paths.getSparrowAtlas('characters/bfCorrupt');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				...
				flipX = true;
				case 'bf-infernum':
				var tex = Paths.getSparrowAtlas('characters/bfCorrupt2');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		if (curCharacter == 'gf' || curCharacter == 'gf-corrupt')
		{
